...
namespace WPFConverter.ViewModels
{
    class UnitConverterViewModel : ObservableObject
    {
        ...
        {
            return new List<string>() { "Inches", "Feet", "Miles", "Millimeters","Centimeters",
                "Meters","Kilometers"};
        }
        private void PreformCalculation(object obj)
        {
            switch (OperandUnit)
            {
                case "Inches":
        ...
        public UnitConverterViewModel()
        {
            ...
            ButtonConvertCommand = new RelayCommand(new Action<object>(PreformCalculation));
        }
    }
}
